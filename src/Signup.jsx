...
const Signup = () => {
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      confirmPassword: Yup.string().oneOf([Yup.ref('password'), null], 'パスワードが一致しません').required('必須項目です'),
    }),
    onSubmit: values => {
      ...
      axios.post('https://app.swaggerhub.com/apis/INFO_3/BookReviewApplication/1.0.0/users', formData)
        .then(response => {
